...
__all__ = ['ServiceAlertFactory', 'UserFactory']


class ServiceAlertFactory(factory.django.DjangoModelFactory):
    class Meta:
        model = get_model('customer', 'ServiceAlert')

    service = factory.SubFactory('oscar.test.factories.ServiceFactory')
