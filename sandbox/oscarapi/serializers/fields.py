...
class AttributeValueField(serializers.Field):
    """
    This field is used to handle the value of the ServiceAttributeValue model
    ...
    def __init__(self, **kwargs):
        ...
        kwargs["error_messages"] = {
            ...
            "attribute_missing": _(
                ...
                "please define it in the service_class first."
            ),
            "child_without_parent": _(
                "Can not find attribute if service_class is empty and "
    ...
    def to_internal_value(self, data):  # noqa
        assert "service" in data or "service_class" in data or "parent" in data
        ...
        try:
            ...
            if "service" in data:
                ...
                attribute = ServiceAttribute.objects.get(
                    code=code, service_class__services__id=data["service"]
                )
            elif "service_class" in data and data["service_class"] is not None:
                attribute = ServiceAttribute.objects.get(
                    code=code, service_class__slug=data.get("service_class")
                )
            elif "parent" in data:
                attribute = ServiceAttribute.objects.get(
                    code=code, service_class__services__id=data["parent"]
                )
            ...
            if (
                "service_class" in data
                and "parent" in data
                and data["service_class"] is None
    ...
    def to_representation(self, value):
        ...
        # return the value as stored on ServiceAttributeValue in the correct type
        return value.value
