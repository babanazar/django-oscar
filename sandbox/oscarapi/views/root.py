...
def PUBLIC_APIS(r, f):
    return [
        ...
        ("basket-add-service", reverse("api-basket-add-service", request=r, format=f)),
        ...
        ("services", reverse("service-list", request=r, format=f)),
...
def ADMIN_APIS(r, f):
    return [
        ("serviceclasses", reverse("admin-serviceclass-list", request=r, format=f)),
        ("services", reverse("admin-service-list", request=r, format=f)),
