...
class BasketTest(APITest):
    ...
    def test_basket_write_permissions_anonymous(self):
        ...
        line_data = {
            ...
            "service": "http://testserver/api/services/1/",
            "stockrecord": "http://testserver/api/services/1/stockrecords/1/",
            "quantity": 3,
            "price_currency": "EUR",
    ...
    def test_add_service_anonymous(self):
        "Test if an anonymous user can add a service to his basket"
        self.response = self.post(
            "api-basket-add-service",
            url="http://testserver/api/services/1/",
            quantity=5,
        )
        self.response.assertStatusEqual(200)
        ...
        self.assertEqual(line0["service"], "http://testserver/api/services/1/")
        self.assertEqual(line0["quantity"], 5)

    def test_add_service_authenticated(self):
        "Test if an authenticated user can add a service to his basket"
        self.login("nobody", "nobody")
        self.response = self.post(
            "api-basket-add-service",
            url="http://testserver/api/services/1/",
    ...
    def test_add_service_basket_addition_signal_send(self, mock):
        """The oscar `basket_addition` signal should be send when adding a service"""
        self.login("nobody", "nobody")
        self.response = self.post(
            "api-basket-add-service",
            url="http://testserver/api/services/1/",
        ...
        self.assertEqual(signal_arguments["service"], Service.objects.get(pk=1))
    ...
    def test_basket_line_permissions(self):
        ...
        self.response.assertStatusEqual(200)
        self.response.assertValueEqual("service", "http://testserver/api/services/1/")
    ...
    def test_add_service_limit_basket(self):
        """Test if an anonymous user cannot add more than two services to his
    ...
    def test_add_service_above_stock(self):
        """Test if an anonymous user cannot add more services to his
    ...
    def test_add_put_service_option(self):
    ...
    def test_service_option_write_permissions_authenticated(self):
        """Another user wants to update my color, but we don't allow that"""
        attribute = self.test_add_put_service_option()
        self.hlogin("somebody", "somebody", session_id="somebody")
