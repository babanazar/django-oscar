...
class TestCategory(TestCase):
    ...
    def test_url_caching(self):
        category = self.services.add_child(name="Fromages français")
        absolute_url = category.get_absolute_url()
        url = cache.get(category.get_url_cache_key())
        self.assertEqual(url, 'services/fromages-français')
        self.assertEqual(absolute_url, '/catalogue/category/services/fromages-fran%C3%A7ais_{}/'.format(category.pk))
